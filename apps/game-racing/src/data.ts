...
const key = isString(NEXT_PUBLIC_SUPABASE_ANON_KEY) ? NEXT_PUBLIC_SUPABASE_ANON_KEY : config.key
const url = isString(NEXT_PUBLIC_SUPABASE_URL) ? NEXT_PUBLIC_SUPABASE_URL : config.url
