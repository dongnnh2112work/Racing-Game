...
import { MotionRuntime } from './input'
...
import { Checkpoint, Clock, Speed, Minimap, Intro, Help, Editor, LeaderBoard, Finished, PickColor, Settings, HandPreview, VirtualSteeringWheel } from './ui'
...
export function App(): JSX.Element {
  ...
  const [actions, dpr, editor, shadows, pairingComplete] = useStore((s) => [s.actions, s.dpr, s.editor, s.shadows, s.ready])
  const motionPaired = useMotionStore((s) => s.pairingComplete)
  ...
  if (!pairingComplete || !motionPaired) {
    return <></>
  }
