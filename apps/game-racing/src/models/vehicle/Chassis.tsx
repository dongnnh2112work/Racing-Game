...
import type { BoxProps, PublicApi } from '@react-three/cannon'
...
export const Chassis = forwardRef<Group, PropsWithChildren<BoxProps>>(({ args = [2, 1.1, 4.7], mass = 500, children, ...props }, ref) => {
  ...
  useFrame((_, delta) => {
    ...
    if (wheel.current) wheel.current.rotation.z = lerp(wheel.current.rotation.z, getState().steering * Math.PI, delta * 8)
