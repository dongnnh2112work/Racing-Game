import type { MotionFrame } from './protocol'
import { PACKET_SIZE } from './protocol'

export function decodeMotionPacket(buffer: ArrayBuffer | Uint8Array): {
  deviceId: string
...
export function packetToMotionFrame(decoded: ReturnType<typeof decodeMotionPacket>, providerType: 'esp32-ws' | 'esp32-ble'): MotionFrame {
  return {
    deviceId: decoded.deviceId,
    providerType,
    timestamp: decoded.firmwareTimestamp,
    confidence: 0.95,
    payload: {
      type: 'orientation',
